...
// DrawingCanvasViewController is a UIViewController managing a PencilKit canvas.
...
// Extension to conform to PKToolPickerObserver and PKCanvasViewDelegate protocols.
